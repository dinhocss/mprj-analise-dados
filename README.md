...
* /Modelagem de Dados: Arquivos contendo o diagrama Entidade-Relacionamento e uma breve explicação sobre a modelagem.
* /SQL: O Jupyter Notebook utilizado para realizar as consultas e alguns arquivos para análise gráfica.
* /Análise Gráfica: Arquivo fonte do dashboard para visualização iterativa local.
